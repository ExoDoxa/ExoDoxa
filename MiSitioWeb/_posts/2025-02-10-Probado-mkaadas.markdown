...
title:  "Hola malparidE, pq en esta pagina somos inclusives!"
...
dato curioso no? como que has gastado al rededor de diez segundos, once o doce si eres pero perramente lento, pero creo que no es el caso, 
de todas formas gracias por darme quince segundos de tu tiempo :3


Por otro lado pilla las siguientes link como para probar que se usar esta cosa y sentirme especial.

Temota: [Rosa pastel].

Pagina de una calidad de persona [Ig misterioso]. 
 
Imagen de un perrito [Perrito].

Imagen de un perro hpta [Perrito HPTA].

[Rosa pastel]: https://www.youtube.com/watch?v=bUkJLkoh3kA&list=RD5j4GY-Jc934&index=3
